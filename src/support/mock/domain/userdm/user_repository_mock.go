...
//
//	mockgen -source=user_repository.go -destination=../../../support/mock/domain/userdm/user_repository_mock.go -package=userdm_mock
//
...
func (m *MockUserRepository) FindByName(ctx context.Context, name userdm.UserName) (*userdm.User, error) {
	m.ctrl.T.Helper()
